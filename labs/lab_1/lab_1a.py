...
def main():
    ...
    name = "Aashneel" # TODO: Insert your name between the double quotes

    print(f"{name}, Welcome to the CSS course!")
    print("I forgot how to find the personal introduction")
    print("will this upload if I dont save")
